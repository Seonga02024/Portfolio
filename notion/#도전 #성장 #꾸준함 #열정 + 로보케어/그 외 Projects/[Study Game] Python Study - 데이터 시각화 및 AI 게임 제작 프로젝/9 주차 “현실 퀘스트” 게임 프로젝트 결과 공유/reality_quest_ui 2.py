...
# --- 게임 설정 ---
QUEST_ITEMS = ["cup", "cell phone", "pen", "mouse", "doll", "book"]
CONFIDENCE_THRESHOLD = 0.95
QUEST_TIME_LIMIT = 200
    ...
    while True:
        ...
        if game_state == STATE_TITLE:
            ...
            if pre_gameplay_flow == 0:
                ...
                background = draw_multiline_korean_text_typing(background, story_text, (WIN_WIDTH//2, TEXT_Y - 20), 20, (0,0,0), pre_game_text_chars)
